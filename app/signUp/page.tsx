...
import { signUpSchema, SignUpType } from "@/lib/validation/signUp";
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-tr from-[#32515a] via-[#89b4bb] to-white">
          ...
          <form className="w-full max-w-xs space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative w-full">
              <input
                ...
                onBlur={() =>
                  setTimeout(() => setFocusConfirmPassword(false), 200)
                } // 🔹 delay kecil
                className="w-full px-4 py-2 border border-gray-200 rounded-md bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#4F7F8C] text-gray-700 pr-10"
              />
              <button
